...
export default collection<AbilityScore>({
  id: ID,
  typeDefs: `#graphql
    type AbilityScore {
      id: String!
  ...
  resolvers: {
    Query: {
      abilityScore: oneResolver<AbilityScore>(ID),
      abilityScores: manyResolver<AbilityScore>(ID),
    },
  },
  entries: [
    {
    ...
    },
    {
      ...
      desc: md`
        ...
        your body through a space, or to otherwise apply brute force to a situation. The Athletics
        skill reflects aptitude in certain kinds of Strength checks.
      `,
      skills: query<Skill>("skills")
        .where("baseAbility", "is", "strength")
        .all(),
    ...
    },
    {
      ...
      shortName: "WIS",
      desc: md`
        Wisdom reflects how attuned you are to the world around you and represents perceptiveness
        and intuition.
        ...
        Insight, Medicine, Perception, and Survival skills reflect aptitude in certain kinds of
        Wisdom checks.
      `,
